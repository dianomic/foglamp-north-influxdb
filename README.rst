===================================
FogLAMP "InfluxDB" C++ North Plugin
===================================

A north plugin to push FogLAMP data into an InflexDB database.
...
source
  The source of data to use, either readings from devices or FogLAMP
  statistics.

Build
-----
To build FogLAMP "InfluxDB" C++ filter plugin:
